...
public class StateText extends TextView {
    ...
    private void setup(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.StateText);
        ...
        mNormalTextColor = a.getColor(R.styleable.StateText_normalTextColor, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.StateText_pressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.StateText_unableTextColor, mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.StateText_animationDuration, mDuration);
        mStateBackground.setEnterFadeDuration(mDuration);
        mStateBackground.setExitFadeDuration(mDuration);

        //set background color
        mNormalBackgroundColor = a.getColor(R.styleable.StateText_normalBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.StateText_pressedBackgroundColor, 0);
        mUnableBackgroundColor = a.getColor(R.styleable.StateText_unableBackgroundColor, 0);
        ...
        //set radius
        mRadius = a.getDimensionPixelSize(R.styleable.StateText_state_button_radius, 0);
        mRound = a.getBoolean(R.styleable.StateText_state_button_round, false);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.StateText_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.StateText_strokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.StateText_normalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.StateText_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.StateText_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.StateText_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.StateText_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.StateText_unableStrokeColor, 0);
        setStroke();
