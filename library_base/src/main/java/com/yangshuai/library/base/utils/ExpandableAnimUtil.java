 ...
 * @created 2019-11-08
 */
public class ExpandableAnimUtil {
     ...
     */
    public static ExpandableAnimUtil newInstance(Context context, View hideView, View down, int height) {
        return new ExpandableAnimUtil(context, hideView, down, height);
    }

    private ExpandableAnimUtil(Context context, View hideView, View down, int height) {
