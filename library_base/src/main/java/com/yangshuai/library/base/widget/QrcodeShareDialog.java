 ...
 * @created 2019-09-04
 */
public class QrcodeShareDialog extends DialogFragment {
    ...
    public QrcodeShareDialog(String title) {
        this.title=title;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.base_qrcode_share_dialog, container);
        initView();
        return rootView;
    }
    ...
    private void initView() {
        ...
        TextView shareTitle = rootView.findViewById(R.id.qrcode_share_title);
