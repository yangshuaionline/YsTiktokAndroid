 ...
 * @created 2020/03/16
 */
public class PickerTimeOptions {
    ...
    public WheelTimeOptions.OnTimeOnOptionsSelectListener optionsSelectListener;
    public WheelTimeOptions.OnTimeOptionsSelectChangeListener optionsSelectChangeListener;

    public OnTimeSelectListener timeSelectListener;
    public View.OnClickListener cancelListener;

    //options picker
    public String label1, label2;//单位字符
    public int option1, option2;//默认选中项
    public int x_offset_one, x_offset_two;//x轴偏移量
    ...
    public PickerTimeOptions() {
        layoutRes = R.layout.base_picker_second_custom;
    }
