...
public class AddressSelector extends LinearLayout implements View.OnClickListener{
    ...
    private void init(Context context){
        ...
        grayLine.setBackgroundColor(mContext.getResources().getColor(R.color.btn_light_gray_e6));
        addView(grayLine);
...
//            }
     ...
     * 设置Tab默认选中
     * */
    public void setTabText(String provinceName,String cityName) {
        tabs.get(0).setText(provinceName);
        tabs.get(1).setText(cityName);
    ...
    private class Line extends LinearLayout{
        ...
        public void setIndex(int index){
            int onceWidth = ScreenUtils.getScreenWidth() /sum;
            this.nowIndex = index;
    ...
    private class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.MyViewHolder>{
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            MyViewHolder viewHolder = new MyViewHolder(LayoutInflater.from(mContext)
                    .inflate(R.layout.base_item_address,parent,false));
            return viewHolder;
        }
        ...
        class MyViewHolder extends RecyclerView.ViewHolder{
            ...
            public MyViewHolder(View itemView) {
                ...
                img = (ImageView) itemView.findViewById(R.id.iv_city_selected);
            }
        }
    }
