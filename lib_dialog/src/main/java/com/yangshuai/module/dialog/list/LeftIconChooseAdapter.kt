 ...
 * Description:
 */
class LeftIconChooseAdapter(
    var context: Context,
    var list: MutableList<ListData>,
    var listener: OnItemChooseBackListener
) :
    RecyclerView.Adapter<LeftIconChooseAdapter.ViewHolder>() {
...
//        val view = View.inflate(context, R.layout.dialog_list_left_icon_item,null)
        ...
        //解析布局
        val item = layoutInflater.inflate(R.layout.dialog_list_left_icon_item,parent,false)
