...
//        mClipBorder.left = mClipPadding + width / 8;
        mClipBorder.left = mClipPadding;
//        mClipBorder.right = width - mClipPadding - width / 8;
    ...
    public void setPadding(int clipPadding) {
    ...
    public Bitmap clip() {
        ...
        return Bitmap.createBitmap(originalBitmap,
                (int) (cropX > 0 ? cropX : 0), (int) (cropY > 0 ? cropY : 0), (int) cropWidth, (int) cropHeight,
                outputMatrix, false);
    }
...
//        canvas.drawRect(mClipBorder.left, mClipBorder.top, mClipBorder.right, mClipBorder.bottom, mPaint);
        ...
        canvas.drawRect(mClipBorder.left, mClipBorder.top, mClipBorder.right, mClipBorder.top+1, paint);
        canvas.drawRect(mClipBorder.left, mClipBorder.bottom, mClipBorder.right, mClipBorder.bottom+1, paint);
        canvas.drawRect(mClipBorder.left, mClipBorder.top, mClipBorder.left+1, mClipBorder.bottom, paint);
        canvas.drawRect(mClipBorder.right, mClipBorder.top, mClipBorder.right+1, mClipBorder.bottom, paint);
