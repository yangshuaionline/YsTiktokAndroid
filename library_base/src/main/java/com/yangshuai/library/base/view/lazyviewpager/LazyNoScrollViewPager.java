package com.yangshuai.library.base.view.lazyviewpager;
 ...
 */
public class LazyNoScrollViewPager extends ViewGroup {
    private static final String TAG = "LazyNoScrollViewPager";
    ...
    public LazyNoScrollViewPager(Context context) {
        super(context);
        initViewPager();
    }

    public LazyNoScrollViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
